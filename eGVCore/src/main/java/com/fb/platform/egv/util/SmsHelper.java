...
public class SmsHelper {
	 ...
	 * @throws MailException
	 */
	public static SmsTO createSmsTO(String mobileNum, BigDecimal amount, String eGVNumber, String eGVPin,
		...
		String message = SMS_TEMPLATE_STR
				.replaceAll(EGV_NUMBER_SMS_TEMPLATE_STR, eGVNumber)
				.replaceAll(EGV_PIN_SMS_TEMPLATE_STR, eGVPin)
				.replaceAll(EGV_AMOUNT_SMS_TEMPLATE_STR, String.valueOf(amount.intValue()))
				.replaceAll(EGV_VALIDITY_SMS_TEMPLATE_STR,
						date.getDayOfMonth() + " " + date.monthOfYear().getAsShortText() + ", " + date.getYear())
