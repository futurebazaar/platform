 ...
 * 
 */
package com.fb.platform.mom.delivery.manager.impl;
...
import com.fb.platform.mom.delivery.manager.DeliveryManager;
import com.fb.platform.mom.delivery.receiver.DeliveryMessageReceiver;
...
public class DeliveryManagerImpl implements ReceiverManager, DeliveryManager {
	...
	public void start() {
		...
		momManager.registerReceiver(PlatformDestinationEnum.DELIVERY, deliveryMessageReceiver);
