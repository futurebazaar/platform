...
public class ItemAckParameterImpl implements ItemAckParameters {
	...
	public List<NameValuePair> getParameters(List<NameValuePair> parameters, ItemTO itemAck) {
		...
		if(itemAck.getDeliveryDate() != null) {
			parameters.add(new BasicNameValuePair("deliveryDate", itemAck.getDeliveryDate().toDate().toString()));
		}
		...
		if(itemAck.getCreatedDate() != null) {
			parameters.add(new BasicNameValuePair("createdDate", itemAck.getCreatedDate().toDate().toString()));
		}
		...
		if(itemAck.getOrderDate() != null) {
			parameters.add(new BasicNameValuePair("orderDate", itemAck.getOrderDate().toDate().toString()));
		}
		parameters.add(new BasicNameValuePair("quantity", String.valueOf(itemAck.getQuantity())));
