...
public class HeaderPartnerMapper {
	...
	public static void setDetails(JCoFunction bapiFunction, OrderHeaderTO orderHeaderTO, AddressTO defaultShippingAddressTO, AddressTO billingAddressTO, TinlaOrderType orderType) {
		...
		setFirstPartnerDetails(orderPartner, orderText, orderHeaderTO, defaultShippingAddressTO);
		setSecondPartnerDetails(orderPartner, orderText, orderHeaderTO, billingAddressTO);
		setThirdPartnerDetails(orderPartner, orderText, orderHeaderTO, defaultShippingAddressTO);
		setFourthPartnerDetails(orderPartner, orderText, orderHeaderTO, defaultShippingAddressTO);
	}

	private static void setFirstPartnerDetails(JCoTable orderPartner,JCoTable orderText,  OrderHeaderTO orderHeaderTO, AddressTO defaultShippingAddressTO) {
		...
		orderPartner.setValue(SapOrderConstants.FULL_NAME, defaultShippingAddressTO.getFirstName() + " " + defaultShippingAddressTO.getLastName());
		orderPartner.setValue(SapOrderConstants.LANGUAGE, SapOrderConstants.DEFAULT_LANGUAGE);
		orderPartner.setValue(SapOrderConstants.CITY, defaultShippingAddressTO.getCity());
		orderPartner.setValue( SapOrderConstants.STATE, defaultShippingAddressTO.getState());
		orderPartner.setValue(SapOrderConstants.COUNTRY, defaultShippingAddressTO.getCountry());
		orderPartner.setValue(SapOrderConstants.PINCODE, defaultShippingAddressTO.getPincode());
		orderPartner.setValue(SapOrderConstants.PRIMARY_PHONE, defaultShippingAddressTO.getPrimaryTelephone());
		orderPartner.setValue(SapOrderConstants.SECONDARY_PHONE, defaultShippingAddressTO.getSecondaryTelephone());
		...
		orderText.setValue(SapOrderConstants.TEXT_LINE, defaultShippingAddressTO.getAddress());
	}
	...
	private static void setThirdPartnerDetails(JCoTable orderPartner,JCoTable orderText,  OrderHeaderTO orderHeaderTO, AddressTO defaultShippingAddressTO) {
		orderPartner.appendRow();
		orderText.appendRow();
		...
		orderPartner.setValue(SapOrderConstants.PINCODE, defaultShippingAddressTO.getPincode());
		orderPartner.setValue(SapOrderConstants.PRIMARY_PHONE, defaultShippingAddressTO.getPrimaryTelephone());
		orderPartner.setValue(SapOrderConstants.FAX_NUMBER, defaultShippingAddressTO.getSecondaryTelephone());
		orderText.setValue(SapOrderConstants.ITEM_NUMBER, SapOrderConstants.DEFAULT_ITEM_NUMER);
	...
	private static void setFourthPartnerDetails(JCoTable orderPartner,JCoTable orderText,  OrderHeaderTO orderHeaderTO, AddressTO defaultShippingAddressTO) {
		orderPartner.appendRow();
		orderText.appendRow();
