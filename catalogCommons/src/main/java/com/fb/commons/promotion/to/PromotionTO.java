...
public class PromotionTO {
	...
	public String getCanBeClaimed() {
		return canBeClaimed;
	}

	public void setCanBeClaimed(String canBeClaimed) {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.DEFAULT_STYLE).append("promotionId", this.getPromotionId()).append("appliesOn", this.getAppliesOn()).toString();
	}
}
