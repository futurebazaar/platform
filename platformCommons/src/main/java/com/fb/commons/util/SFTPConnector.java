...
public class SFTPConnector {	
	...
	public void connect(boolean strictHostKeyChecking, int timeout){
		JSch jsch = new JSch();
	...
	public void upload(String dataToUpload, String fileName, String remoteDirectory) throws PlatformException, 
