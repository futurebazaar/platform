...
public class FirstFlightOutboundImpl implements ShipmentOutbound {
	...
	private void loadProperties() {
		try {
			...
			serverFilePath = prop.getProperty("future.server.outbound.firstFlight");
			prop.clear();
			...
			extension = prop.getProperty("firstFlight.outbound.extension");
			fileNamePrefix = prop.getProperty("firstFlight.outbound.fileNamePrefix");
			fileNameFormat = prop.getProperty("firstFlight.outbound.fileNameFormat");
	...
	private boolean generateFile(List<ParcelItem> parcelItemList) {
