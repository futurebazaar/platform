...
public class BuyXQuantityGetVariablePercentOffRuleImpl implements PromotionRule, Serializable {
	...
	public void init(RuleConfiguration ruleConfig) {
		...
		data = (BuyXQuantityGetVariablePercentOffRuleData) RulesEnum.BUY_X_QUANTITY_GET_VARIABLE_PERCENT_OFF.getRuleData(ruleConfig);
	...
	public PromotionStatusEnum isApplicable(OrderRequest request,int userId,boolean isCouponCommitted) {
		...
		int relevantProductQuantity = request.getOrderQuantityForRelevantProducts(data.getBrands(), data.getIncludeCategoryList(), data.getExcludeCategoryList());
