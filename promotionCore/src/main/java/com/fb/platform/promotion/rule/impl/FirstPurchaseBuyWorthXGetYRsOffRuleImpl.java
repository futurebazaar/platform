...
public class FirstPurchaseBuyWorthXGetYRsOffRuleImpl implements PromotionRule {
	...
	private static transient Log log = LogFactory
			.getLog(FirstPurchaseBuyWorthXGetYRsOffRuleImpl.class);
	...
	public void init(RuleConfiguration ruleConfig) {
		...
		data = (FirstPurchaseBuyWorthXGetYRsOffRuleData) RulesEnum.FIRST_PURCHASE_BUY_WORTH_X_GET_Y_RS_OFF
	...
	public PromotionStatusEnum isApplicable(OrderRequest request, int userId,
		...
		if (log.isDebugEnabled()) {
			log.debug("Checking if FirstPurchaseBuyWorthXGetYRsOffRuleImpl applies on order : "
					+ request.getOrderId());
		}
	...
	public OrderDiscount execute(OrderDiscount orderDiscount) {
		...
		if (log.isDebugEnabled()) {
			log.debug("Executing FirstPurchaseBuyWorthXGetYRsOffRuleImpl on order : "
					+ request.getOrderId());
		}
	...
	public RuleConfigDescriptor getRuleConfigs() {
		...
		ruleConfigDescriptor
				.addConfigItemDescriptor(new RuleConfigItemDescriptor(
						RuleConfigDescriptorEnum.FIXED_DISCOUNT_RS_OFF, true));
