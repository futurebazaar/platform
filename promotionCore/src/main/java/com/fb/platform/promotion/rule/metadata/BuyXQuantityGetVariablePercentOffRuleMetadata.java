 ...
 *
 */
public class BuyXQuantityGetVariablePercentOffRuleMetadata extends RuleConfigMetadata {

	public BuyXQuantityGetVariablePercentOffRuleMetadata() {
		...
		ruleConfigItemMetadata.add(new RuleConfigItemMetadata(RuleConfigDescriptorEnum.VARIABLE_DISCOUNT_PERCENTAGE, true));
