...
public class ZTINLASEGDLVR {
    ...
    @XmlElement(name = "SEG_NUM")
    protected int segnum;
    @XmlElement(name = "PO_NUM", required = true)
    protected String ponum;
    @XmlElement(name = "CAN_GR", required = true)
    protected String cangr;
    ...
    /**
     * Gets the value of the cangr property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the cangr property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setCANGR(String value) {
        this.cangr = value;
    }
