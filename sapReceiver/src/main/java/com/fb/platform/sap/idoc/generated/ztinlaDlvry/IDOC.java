...
/**
 * IMP: This file was autogenerated by Jaxb from the src/test/resources/ztinlaDlvry.xsd. Then the generated classes 
 ...
 *         &lt;element ref="{}ZTINLA_DLVRY" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
public class IDOC {
    ...
    @XmlElement(name = "ZTINLA_DLVRY", required = true)
    protected List<ZTINLADLVRY> ztinladlvry;
    ...
    /**
     * Gets the value of the ztinladlvry property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the ztinladlvry property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getZTINLADLVRY().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ZTINLADLVRY> getZTINLADLVRY() {
        if (ztinladlvry == null) {
            ztinladlvry = new ArrayList<ZTINLADLVRY>();
        }
        return this.ztinladlvry;
    }
