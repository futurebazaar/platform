...
public class GenerateSendWalletPasswordImpl implements GenerateSendWalletPassword{
	...
	private Log log = LogFactory.getLog(GenerateSendWalletPasswordImpl.class);
