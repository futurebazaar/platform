...
public enum WalletSummaryStatusEnum {
	...
	SUCCESS("SUCCESS"), INVALID_USER("INVALID USER"), INACTIVE_WALLET("INACTIVE WALLET"), NO_SESSION("NO SESSION"), ERROR_RETRIVING_WALLET_SUMMARY(
			"ERROR RETRIVING WALLET SUMMARY");
